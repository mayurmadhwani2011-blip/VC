...
const serviceDescription = process.env.CLINIC_SERVICE_DESCRIPTION || 'Clinic Management System - Web Server on port 5000';
const port = String(process.env.CLINIC_PORT || process.env.PORT || '5000');
...
svc.on('start', function () {
  console.log('Clinic service is running on http://localhost:5000');
});
