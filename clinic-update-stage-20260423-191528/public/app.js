...
const PAGE_TITLES = {
  ...
  'owner-control': ['Owner Control', 'Clinic profile, subscription, backup, restore, printer and reset controls'],
    ...
    <div class="setup-layout">
      <div class="setup-head">
        <div>
          ...
          <div class="setup-subtitle">Manage clinic profile, subscription, backups, restore, printer settings, and system reset.</div>
        </div>
      </div>
